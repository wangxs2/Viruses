  ...
  <div class="home">
    ...
    <van-overlay  :show="isDetail" :z-index="99" :duration="0"	>
      <div class="hospatilBox">
        <div class="contentDetail">
          ...
          <div v-if="mapobj.needsNamearr!==undefined" style="display:flex;justify-content:flex-start;align-items:center;font-weight:bold;font-size:16px;text-align:left;margin-bottom:14px">{{query.orgType==1?'招聘岗位':'提供的岗位和服务'}} <van-icon v-if="query.orgType==1" style="margin-left:10px;margin-right:1px" name="warning-o" color="#FF2727"  size="12" /></div>
    ...
    <van-popup v-model="agreement" closeable position="bottom" :style="{ height: '100%' }">
      <div class="agreement-content">
        ...
        <div class="contentfont">1.1 用户在同意本网站：全国工商联复工复产人才对接平台(http://rcez.acfic.org.cn:9966/visur/#/)的《用户使用协议》（以下简称“本协议”）后，方可使用本网络服务平台（以下简称“平台”)提供的人才需求与供应信息来源等相关服务（以下简称“服务”）。</div>
        ...
        <div class="contentfont">4.5 本平台唯一官方网址：http://rcez.acfic.org.cn:9966/visur/#/（全国工商联复工复产人才对接平台），如被第三方恶意篡改或假借名义进行不正当行为，与本平台无关，本平台不对用户或任何第三方受到的损害负责，但本平台保留对恶意第三方追究法律责任的权利。</div>
