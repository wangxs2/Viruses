  ...
  <div class="home">
    ...
    <div class="bottom-btn-write">
      ...
      <div class="write-wrapper">
        <div class="write">
          <p>更多用工信息：全国工商联复工复产人才对接平台 <span style="color:#1989fa" @click="agreement=true">用户协议</span></p>
        </div>
    ...
    <van-overlay  :show="isDetail" :z-index="99" :duration="0"	>
      <div class="hospatilBox">
        <div class="contentDetail">
          ...
          <div v-if="mapobj.needsNamearr!==undefined" style="display:flex;justify-content:flex-start;align-items:center;font-weight:bold;font-size:16px;text-align:left;margin-bottom:14px">{{query.orgType==1?'所需岗位':'可提供的岗位'}}</div>
